...
export function SyncButtons() {
  const t = useTranslations("ta.candidates.sheetSync");
  ...
  function handlePull() {
    ...
    startTransition(async () => {
      ...
      if (result.ok) setMessage({ type: "ok", text: t("pullSuccess", { imported: result.imported, skipped: result.skipped }) });
  ...
  function handlePush() {
    ...
    startTransition(async () => {
      ...
      if (result.ok) setMessage({ type: "ok", text: t("pushSuccess", { imported: result.imported }) });
      else setMessage({ type: "error", text: result.error });
    });
  }
