...
import { deleteProjectContract } from "../actions";

export function DeleteContractButton({ contractId }: { contractId: string }) {
  const t = useTranslations("pmo.contracts.deleteContractButton");
  ...
  function handleClick() {
    ...
    startTransition(async () => {
      setError(null);
      const result = await deleteProjectContract(contractId);
