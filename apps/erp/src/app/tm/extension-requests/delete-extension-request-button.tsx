...
import { deleteExtensionRequest } from "../actions";

export function DeleteExtensionRequestButton({ requestId }: { requestId: string }) {
  ...
  function handleClick() {
    ...
    startTransition(async () => {
      setError(null);
      const result = await deleteExtensionRequest(requestId);
