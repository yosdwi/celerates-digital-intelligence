...
import { deleteTalentAssignment } from "./actions";

export function DeleteTalentAssignmentButton({ assignmentId }: { assignmentId: string }) {
  ...
  function handleClick() {
    ...
    startTransition(async () => {
      setError(null);
      const result = await deleteTalentAssignment(assignmentId);
